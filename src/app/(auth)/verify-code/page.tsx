          ...
          <div className="flex justify-center gap-2.5">
            {digits.map((digit, index) => (
              <input
                ...
                className="size-12 rounded-lg border border-atlas-borderMuted bg-transparent text-center text-base font-semibold text-atlas-text outline-none transition-colors focus:border-atlas-gold disabled:opacity-60"
              />
            ))}
          </div>
